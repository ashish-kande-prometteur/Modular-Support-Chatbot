...
#         # Existing tickets keep original ids
#         ticket_id = chunk.get(
#             "ticket_id"
#         )

#         ticket_number = chunk.get(
#             "ticket_number"
#         )

#         # Generate synthetic ids for docs
#         if not ticket_id:
#             ticket_id = (
#                 f"{chunk.get('source', 'doc')}_"
#                 f"{inserted}"
#             )

#         if not ticket_number:
#             ticket_number = (
#                 f"{chunk.get('source', 'DOC').upper()}-"
#                 f"{inserted}"
#             )
